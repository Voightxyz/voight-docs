...
- **Reaches out for real.** With LinkedIn [connected](/agents/channels) (X is days away), it drafts personalized outreach and follow-ups and sends them once you approve. Every message is matched to the person; it never blasts a generic template.
...
- **Verifiable sports data (preview).** With [TxLINE](/agents/txline) enabled, it reads Solana-anchored live odds, runs a deterministic sharp-movement detector, and anchors its committed picks on Solana.
...
- [Channels](/agents/channels): connect Telegram, GitHub and LinkedIn (X is days away)
