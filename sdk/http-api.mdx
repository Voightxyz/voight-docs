...
For most use cases, the [library mode SDK](/sdk/library-mode) is the right call — `import { scrubPii } from '@voightxyz/sdk'` gives you the same scrubbing without adopting the hook handler.
...
<CardGroup cols={2}>
  ...
  <Card title="POST /v1/events reference" icon="bolt" href="/api-reference/events">
