...
| **App SDKs** | `@voightxyz/openai` (today) · `@voightxyz/anthropic` (next) | Wrap your provider SDK in production apps — automatic LLM-call capture | [OpenAI SDK](/ai-apps/openai) |
